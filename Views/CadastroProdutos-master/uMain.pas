...
procedure Tcad01.CarregaProduto;
var Img :TStream;
begin
...
procedure Tcad01.edtCodigoTyping(Sender: TObject);
begin
  CarregaProduto;
end;

procedure Tcad01.FDConnection1AfterConnect(Sender: TObject);
begin
...
procedure Tcad01.FDConnection1BeforeConnect(Sender: TObject);
begin
   FDConnection1.DriverName := 'SQLite';
   FDConnection1.Params.Values['DataBase'] := TPath.Combine(TPath.GetDocumentsPath,'Firebase.S3DB');
end;

procedure Tcad01.FormCreate(Sender: TObject);
begin
...
procedure Tcad01.ListarProdutos;
var
   ListBoxItem1: TListBoxItem;
...
procedure Tcad01.ListBox1ItemClick(const Sender: TCustomListBox;
  const Item: TListBoxItem);
begin
...
procedure Tcad01.Rectangle2MouseLeave(Sender: TObject);
begin
...
procedure Tcad01.Rectangle2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
...
procedure Tcad01.Rectangle3Click(Sender: TObject);
begin
   ChangeTabAction1.Execute;
end;

procedure Tcad01.Rectangle3MouseLeave(Sender: TObject);
begin
   TRectangle(Sender).Fill.Color :=  TAlphaColors.White;
...
procedure Tcad01.Rectangle3MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
   TRectangle(Sender).Fill.Color := TAlphaColors.Cornflowerblue;
   Rectangle6.Fill.Color := TRectangle(Sender).Fill.Color;
...
procedure Tcad01.Rectangle4Click(Sender: TObject);
begin
   ChangeTabAction2.Execute;
end;

procedure Tcad01.Rectangle4MouseLeave(Sender: TObject);
begin
   TRectangle(Sender).Fill.Color :=  TAlphaColors.White;
   Text2.TextSettings.FontColor :=  Text5.TextSettings.FontColor;
end;

procedure Tcad01.Rectangle4MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
   TRectangle(Sender).Fill.Color := TAlphaColors.Cornflowerblue;
...
procedure Tcad01.Rectangle5Click(Sender: TObject);
begin
   ChangeTabAction3.Execute;
end;

procedure Tcad01.Rectangle5MouseLeave(Sender: TObject);
begin
   TRectangle(Sender).Fill.Color :=  TAlphaColors.White;
   Text3.TextSettings.FontColor := Text5.TextSettings.FontColor;
end;

procedure Tcad01.Rectangle5MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
   TRectangle(Sender).Fill.Color := TAlphaColors.Cornflowerblue;
...
procedure Tcad01.Rectangle9Click(Sender: TObject);
begin
   OpenDialog1.Execute;
...
procedure Tcad01.SpeedButton2Click(Sender: TObject);
var
...
procedure Tcad01.Text4Click(Sender: TObject);
begin
